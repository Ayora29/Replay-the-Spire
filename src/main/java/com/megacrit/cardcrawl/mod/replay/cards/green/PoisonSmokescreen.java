...
public class PoisonSmokescreen extends CustomCard {
    ...
    public PoisonSmokescreen() {
        super(ID, PoisonSmokescreen.NAME, "replay/images/cards/Poison_Smokescreen.png", PoisonSmokescreen.COST, PoisonSmokescreen.DESCRIPTION, CardType.SKILL, CardColor.GREEN, CardRarity.UNCOMMON, CardTarget.ALL_ENEMY);
        this.baseBlock = 6;
