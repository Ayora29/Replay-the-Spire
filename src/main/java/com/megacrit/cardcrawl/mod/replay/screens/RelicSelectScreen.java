package com.megacrit.cardcrawl.mod.replay.screens;
...
public class RelicSelectScreen implements ScrollBarListener {
    ...
    private final float scrollLowerBound = Settings.HEIGHT - 200.0F * Settings.scale;
    ...
    private final ArrayList<AbstractRelic> selectedRelics = new ArrayList<>();
