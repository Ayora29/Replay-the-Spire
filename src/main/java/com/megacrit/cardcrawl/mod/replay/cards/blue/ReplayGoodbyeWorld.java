...
import com.megacrit.cardcrawl.mod.replay.powers.GoodbyeWorldPower;
...
public class ReplayGoodbyeWorld extends CustomCard {
    ...
    public ReplayGoodbyeWorld() {
        super(ID, ReplayGoodbyeWorld.NAME, "replay/images/cards/empty_bin.png", ReplayGoodbyeWorld.COST, ReplayGoodbyeWorld.DESCRIPTION, CardType.POWER, CardColor.BLUE, CardRarity.UNCOMMON, CardTarget.SELF);
