...
public class BasicMightCard
    ...
    public BasicMightCard() {
        super(ID, NAME, "replay/images/cards/might.png", BasicMightCard.COST, DESCRIPTION, AbstractCard.CardType.POWER, AbstractCard.CardColor.COLORLESS, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.NONE);
