...
public class Necrogeddon
    ...
    public Necrogeddon() {
        super(ID, NAME, "replay/images/cards/necrogeddon.png", 0, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.COLORLESS, AbstractCard.CardRarity.RARE, AbstractCard.CardTarget.ENEMY);
