...
public class CorrosionCurse extends CustomCard {
    ...
    private static final String BETA_ART = "replay/images/cards/corrosionCurseBeta.png";

    public CorrosionCurse() {
        super(ID, CorrosionCurse.NAME, "replay/images/cards/corrosionCurse.png", COST, CorrosionCurse.DESCRIPTION, CardType.SKILL, CardColor.RED, CardRarity.UNCOMMON, CardTarget.ENEMY);
