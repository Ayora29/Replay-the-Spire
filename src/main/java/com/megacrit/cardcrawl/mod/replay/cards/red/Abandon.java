...
public class Abandon
    ...
    public Abandon() {
        super("Abandon", NAME, "replay/images/cards/abandon.png", COST, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCard.CardColor.RED, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.NONE);
