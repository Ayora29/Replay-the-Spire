...
public class Massacre
    ...
    public Massacre() {
        super("Massacre", NAME, "replay/images/cards/massacre.png", 1, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.RED, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.ALL_ENEMY);
