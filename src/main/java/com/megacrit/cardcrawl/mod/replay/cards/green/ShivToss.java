...
public class ShivToss extends CustomCard {
    ...
    public ShivToss() {
        super(ShivToss.ID, ShivToss.NAME, "replay/images/cards/shiv_toss.png", COST, ShivToss.DESCRIPTION, CardType.SKILL, CardColor.GREEN, CardRarity.UNCOMMON, CardTarget.SELF);
