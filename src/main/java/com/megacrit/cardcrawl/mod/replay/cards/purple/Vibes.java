...
public class Vibes extends CustomCard {
    ...
    public Vibes() {
        super(ID, Vibes.NAME, "replay/images/cards/vibes.png", COST, Vibes.DESCRIPTION, CardType.SKILL, CardColor.PURPLE, CardRarity.UNCOMMON, CardTarget.ENEMY);
    ...
    private void updateStuff() {
        if (AbstractDungeon.player != null && AbstractDungeon.player.stance != null && AbstractDungeon.player.stance.ID.equals(WrathStance.STANCE_ID) || AbstractDungeon.player.stance.ID.equals(CalmStance.STANCE_ID)) {
            ...
            if (AbstractDungeon.player.stance.ID.equals(CalmStance.STANCE_ID)) {
                ...
                this.changeImage("replay/images/cards/good_vibes.png");
            } else {
                this.name = Vibes.EXTENDED_DESCRIPTION[1] + Vibes.NAME;
                this.changeImage("replay/images/cards/bad_vibes.png");
            }
            if (this.upgraded) {
                this.name += "+";
            ...
            this.changeImage("replay/images/cards/vibes.png");
            if (this.upgraded) {
                this.name += "+";
                this.initializeTitle();
            }
