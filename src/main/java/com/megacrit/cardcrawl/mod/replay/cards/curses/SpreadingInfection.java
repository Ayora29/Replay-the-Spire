...
public class SpreadingInfection extends CustomCard {
    ...
    public SpreadingInfection() {
        super("Spreading Infection", SpreadingInfection.NAME, "replay/images/cards/SporeCrump.png", -2, SpreadingInfection.DESCRIPTION, CardType.CURSE, CardColor.CURSE, CardRarity.CURSE, CardTarget.NONE);
    }
    ...
    public void triggerOnEndOfTurnForPlayingCard() {
        this.cardsToCopy = new ArrayList<>();
