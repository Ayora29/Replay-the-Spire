...
public class ReroutePower extends CustomCard {
    ...
    public ReroutePower() {
        super(ID, ReroutePower.NAME, "replay/images/cards/reroute_power.png", ReroutePower.COST, ReroutePower.DESCRIPTION, CardType.SKILL, CardColor.BLUE, CardRarity.UNCOMMON, CardTarget.NONE);
