...
public class BagOfTricks extends CustomCard {
    ...
    public BagOfTricks() {
        super(ID, NAME, "replay/images/cards/bagOfTricks.png", COST, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCard.CardColor.GREEN, AbstractCard.CardRarity.RARE, AbstractCard.CardTarget.ENEMY);
